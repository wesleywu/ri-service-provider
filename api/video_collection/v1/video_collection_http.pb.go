...
func RegisterVideoCollectionHTTPServer(s *http.Server, srv VideoCollectionHTTPServer) {
	...
	r.PATCH("/v1/video-collection", _VideoCollection_Update0_HTTP_Handler(srv))
	r.PUT("/v1/video-collection", _VideoCollection_Upsert0_HTTP_Handler(srv))
	r.DELETE("/v1/video-collection", _VideoCollection_Delete0_HTTP_Handler(srv))
}
