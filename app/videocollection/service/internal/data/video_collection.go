...
func NewVideoCollectionRepo(mongoClient *mongodb.Client, helper *log.Helper) biz.VideoCollectionRepo {
	collection := mongoClient.Collection(collectionNameVideoCollection)
