...
require (
	github.com/castbox/go-guru v0.2.14
...
require (
	...
	github.com/go-kratos/kratos/contrib/log/zerolog/v2 v2.0.0-20240611160111-eb07954ab60a // indirect
	...
	github.com/wesleywu/gcontainer v0.9.9 // indirect
