...
require (
	github.com/castbox/go-guru v0.1.5
...
replace github.com/castbox/go-guru v0.1.5 => ../go-guru
...
require (
	...
	github.com/wesleywu/gcontainer v0.9.4 // indirect
	github.com/wesleywu/go-lifespan v0.8.2 // indirect
