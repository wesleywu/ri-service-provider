...
require (
	github.com/castbox/go-guru v0.1.35
...
replace (
	github.com/castbox/go-guru => ../go-guru
)
...
require (
	...
	github.com/go-kratos/kratos/contrib/log/zerolog/v2 v2.0.0-20240430092255-be624d035565 // indirect
